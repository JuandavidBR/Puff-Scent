    ...
    <>
      ...
      <div className="min-h-screen bg-background pt-20">
          ...
          <div className="container mx-auto px-6 py-20">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed mb-12 text-pretty">
                ¡HABLEMOS DE VAPEADORES Y PERFUMES!
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/perfumes">
                  <Button className="bg-primary text-primary-foreground hover:bg-primary/90 text-sm tracking-wider uppercase px-8" size="lg">
                    Perfumes
                  </Button>
                </Link>
                <Link href="/vapes">
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                <p className="text-sm tracking-widest uppercase text-muted-foreground mb-4">
                  Ofrecemos Todo Tipo De Perfumes
                </p>
                <h3 className="font-serif text-5xl md:text-6xl text-foreground text-balance">
                  Desde Fragancias muy comunes hasta las más exclusivas
                </h3>
              </div>
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                >
                  <div
                    className={`aspect-[3/4] bg-card mb-4 overflow-hidden relative ${
                      rotatingId === 1 ? "animate-rotate" : ""
                    }`}
                  >
                    <img
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-sm text-muted-foreground mb-3 leading-relaxed">
                      Notas florales delicadas que evocan un jardín en
                      primavera
                    </p>
                        ...
                        {[...Array(40)].map((_, i) => (
                          <div
                            ...
                            style={{
                              ...
                              boxShadow:
                                "0 2px 8px rgba(253,164,175,0.3)",
                            }}
                          />
                        ))}
                      </div>
        ...
        <section className="py-20">
          <div className="container mx-auto px-6">
            <div className="max-w-6xl mx-auto">
              <h3 className="font-serif text-4xl md:text-5xl text-foreground mb-6 text-center">
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-primary-foreground/80 mb-8 leading-relaxed text-pretty">
                Recibe ofertas especiales, lanzamientos anticipados y consejos
                de expertos sobre el mundo de las fragancias de lujo.
              </p>
