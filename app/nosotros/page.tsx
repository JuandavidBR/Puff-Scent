          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed text-pretty">
                En Puffscent, creemos que cada fragancia cuenta una historia
                única. Nuestra pasión por la perfumería nace del deseo de crear
              ...
              <div className="grid md:grid-cols-2 gap-12 items-center bg-card p-8 md:p-12 shadow-lg">
                <div className="order-2 md:order-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-6 text-pretty">
                    "Como en el fútbol, la perfección en la perfumería requiere
                    dedicación, pasión y un compromiso inquebrantable con la
                    excelencia. Puffscent representa esos mismos valores que me
                    han llevado a alcanzar los más altos logros."
                  </p>
                  <p className="font-serif text-xl text-foreground mb-2">
                    Cristiano Ronaldo
                  </p>
                  <p className="text-sm text-muted-foreground">
                    5x Balón de Oro • Leyenda del Fútbol
                  </p>
                </div>
                <div className="order-1 md:order-2">
                  ...
                  >
                    <img
                      src={
                        isSmiling
                          ? "/cristiano-ronaldo-smiling-wearing-elegant-sunglasse.jpg"
                          : "/cristiano-ronaldo-wearing-elegant-sunglasses-holdi.jpg"
                      }
                      alt="Cristiano Ronaldo con el Balón de Oro"
                      className={`w-full h-full object-cover transition-all duration-500 ${
                        isSmiling ? "brightness-110 scale-105" : ""
                      }`}
                    />
                    {isSmiling && (
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center p-8 bg-card">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-pretty">
                    Cada fragancia es creada con técnicas artesanales
                    transmitidas por generaciones de maestros perfumistas.
                  </p>
                </div>
                ...
                <div className="text-center p-8 bg-card">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-pretty">
                    Nuestra pasión por la perfumería impulsa cada decisión,
                    desde la selección de ingredientes hasta el diseño final.
                  </p>
                </div>
                ...
                <div className="text-center p-8 bg-card">
                  ...
                  <p className="text-muted-foreground leading-relaxed text-pretty">
                    No aceptamos nada menos que la perfección absoluta en cada
                    aspecto de nuestras creaciones.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16">
                ...
                <p className="text-lg text-muted-foreground max-w-3xl mx-auto text-pretty">
                  Cada fragancia de Puffscent pasa por un riguroso proceso de
                  creación que puede tomar meses, incluso años, hasta alcanzar
                  la perfección.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col justify-center space-y-8">
                  <div>
                    <div className="text-accent font-serif text-xl mb-2">
                      01
                    </div>
                    <h4 className="font-serif text-2xl text-foreground mb-3">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-pretty">
                      Viajamos por el mundo en busca de las mejores esencias
                      naturales, desde rosas búlgaras hasta oud indonesio.
                    </p>
                  </div>
                  <div>
                    <div className="text-accent font-serif text-xl mb-2">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-pretty">
                      Nuestros maestros perfumistas combinan arte y ciencia para
                      crear composiciones únicas e inolvidables.
                    </p>
                  </div>
                  <div>
                    <div className="text-accent font-serif text-xl mb-2">
                    ...
                    <p className="text-muted-foreground leading-relaxed text-pretty">
                      Cada lote es probado meticulosamente para garantizar que
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-lg text-muted-foreground mb-8 text-pretty">
                Descubre cómo nuestras fragancias pueden transformar tu
                experiencia diaria en algo verdaderamente extraordinario.
              </p>
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-4 gap-12">
              <div className="md:col-span-2">
                ...
                <p className="text-sm text-muted-foreground leading-relaxed max-w-sm">
                  Experiencias sensoriales únicas a través de fragancias
                  exclusivas que definen tu esencia.
                </p>
              </div>

              <div>
                <h5 className="text-sm font-medium uppercase tracking-wider mb-4 text-foreground">
                  Tienda
                </h5>
